...
function App() {
  ...
  const convertFiles = async () => {
    ...
    // Mark all files that aren't already processed as processing
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="p-4">
              ...
              <nav className="space-y-2">
                <button className="w-full bg-gray-900 text-white px-3 py-2 rounded-lg flex items-center space-x-3 hover:bg-gray-800">
        ...
        <div className="flex-1 p-8 overflow-y-auto h-screen">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-8">
              <h1 className="text-xl font-semibold text-gray-900">HEIC to JPG Converter</h1>
